...
class StreamlitTranslator:
    ...
    def _detect_language_locally(self, text):
        ...
        native_patterns = {
            'hi': ['का', 'के', 'की', 'को', 'से', 'में', 'और', 'है', 'हैं', 'था', 'थे', 'होगा', 'होंगे'],
            'bn': ['এর', 'এক', 'সে', 'তার', 'আমি', 'আমার', 'যে', 'কি', 'না', 'হয়', 'আছে', 'করা'],
            'gu': ['એ', 'છે', 'માં', 'ને', 'નો', 'કે', 'અને', 'થી', 'તે', 'આ', 'કરવા', 'હોય'],
            'kn': ['ಅವರು', 'ಇದು', 'ಆ', 'ಈ', 'ಮತ್ತು', 'ಅಥವಾ', 'ಹಾಗೂ', 'ಆದರೆ', 'ಆದ್ದರಿಂದ'],
            'ml': ['അത്', 'ഇത്', 'എന്ന്', 'ആണ്', 'ഉണ്ട്', 'ചെയ്യുക', 'കൂടുതൽ', 'വേണ്ടി'],
            'mr': ['आहे', 'असा', 'असे', 'या', 'ते', 'त्या', 'मी', 'तू', 'आम्ही', 'तुम्ही'],
            'od': ['ଏହା', 'ସେ', 'ମୁଁ', 'ତୁମେ', 'ଆମେ', 'ସେମାନେ', 'କରିବା', 'ହେବା'],
            'pa': ['ਇਹ', 'ਉਹ', 'ਮੈਂ', 'ਤੁਸੀਂ', 'ਅਸੀਂ', 'ਉਹ', 'ਕਰਨਾ', 'ਹੋਣਾ', 'ਵਿੱਚ'],
            'ta': ['அது', 'இது', 'என்று', 'உள்ளது', 'செய்ய', 'வேண்டும்', 'போல்', 'மற்றும்'],
            'te': ['అది', 'ఇది', 'అని', 'ఉంది', 'చేయాలి', 'వేండి', 'మరియు', 'కూడా']
        }
